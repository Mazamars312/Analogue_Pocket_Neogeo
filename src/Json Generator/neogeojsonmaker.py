...
for line in fileinput.input("King of Fighters 2000.json", inplace=True):
    ...
    # open both files
with open('template.json','r') as firstfile, open('King of Fighters 2001, The (NGH-2621).json','w') as secondfile:
...
# This for loop scans and searches each line in the file
# By using the input() method of fileinput module
for line in fileinput.input("King of Fighters 2001, The (NGH-2621).json", inplace=True):
...
for line in fileinput.input("Metal Slug 4.json", inplace=True):
    ...
    # open both files
with open('template.json','r') as firstfile, open('Metal Slug 4 (NGH-2630).json','w') as secondfile:
...
# This for loop scans and searches each line in the file
# By using the input() method of fileinput module
for line in fileinput.input("Metal Slug 4 (NGH-2630).json", inplace=True):
...
# open both files
with open('template.json','r') as firstfile, open('Samurai Shodown V (NGH-2700).json','w') as secondfile:
...
# This for loop scans and searches each line in the file
# By using the input() method of fileinput module
for line in fileinput.input("Samurai Shodown V (NGH-2700).json", inplace=True):
