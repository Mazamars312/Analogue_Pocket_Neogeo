...
# ACDS 20.1 720 win32 2022.06.07.03:29:24
...
# ----------------------------------------
# If pll_cram is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_cram.vo"
fi
