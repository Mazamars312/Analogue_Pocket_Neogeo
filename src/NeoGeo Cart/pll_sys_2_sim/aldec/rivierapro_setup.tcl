...
# ACDS 20.1 720 win32 2023.01.06.23:16:34
# ----------------------------------------
...
# ----------------------------------------
# If pll_sys_2 is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_sys_2.vo"
}
